        ...
        <div className="container grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div className="flex gap-5 flex-col">
            <div className="flex items-center gap-4">
              <h3 className="text-grey">COMPANY</h3>
          ...
          <div className="flex gap-5 flex-col">
            <div className="flex items-center gap-4">
              <h3 className="text-grey">HEADQUARTERS</h3>
              <div className="h-[1px] w-full bg-grey" />
            </div>
            <ul className="flex gap-5 flex-col">
              <li>
          ...
          <div className="flex gap-5 flex-col">
            <div className="flex items-center gap-4">
              <h3 className="text-grey">NEWSLETTER</h3>
              <div className="h-[1px] w-full bg-grey" />
            </div>
            <p>Stay always in touch! Subscribe to our newsletter.</p>
            <div className="p-1 border border-grey flex items-center">
              <input
                type="email"
                placeholder="Email"
              ...
              <svg
                ...
                fill="none"
              >
                <rect y="0.950195" width="66" height="42" fill="#565D67" />
                <path
            ...
            <p>
              <span className="text-grey">*</span> Don’t worry, we don’t spam.
            </p>
          </div>
        </div>
      </div>
      <div className="bg-black/30 py-5 px-5">
        <div className="container flex items-center justify-between gap-10 flex-wrap">
          <p className="text-black">
            © Copyright 2023{" "}
            <span className="text-grey font-bold">Dynamic Layers</span> - All
            Rights Reserved
          </p>
          <div className="flex items-center gap-6">
            <FaFacebookF className="cursor-pointer transition-all hover:text-grey text-base" />
            <FaTwitter className="cursor-pointer transition-all hover:text-grey text-base" />
            <FaGoogle className="cursor-pointer transition-all hover:text-grey text-base" />
            <RiInstagramFill className="cursor-pointer transition-all hover:text-grey text-base" />
          </div>
        </div>
      </div>
    </footer>
